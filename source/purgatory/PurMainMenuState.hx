...
{
	public static var psychEngineVersion:String = "0.3.1 Dave"; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Forever Engine Legacy v" + psychEngineVersion, 12);
